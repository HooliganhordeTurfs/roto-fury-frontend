...
const coinGeckoIds = ['fanfury', 'chihuahua-token', 'lion-dao', 'terra-luna', 'comdex', 'cosmos', 'injective-protocol', 'juno-network', 'sei-network', 'terra-luna-2', 'wrapped-bitcoin', 'tether', 'usk', 'osmosis']
