...
import { FURY_TOKEN_SYMBOL } from 'constants/index'
import { useMultipleTokenBalance } from 'hooks/useTokenBalance'
import { useFuryPrice } from 'hooks/useFuryPrice'
...
const Bonding: FC = () => {
  ...
  const symbols = useMemo(() => {
    ...
    return Array.from(new Set([...tokenSymbols, FURY_TOKEN_SYMBOL]))
  }, [config])
          ...
          <VStack width="flex" alignItems={{
            ...
            <HStack ml={{
              ...
              <Stack direction={['column', 'row']}>
                <Text as="h2" fontSize="24" fontWeight="900">
                  Bonding - Earn swap fees with ampFury or bFury.
                </Text>
                <Button
                  variant="link"
                  color="white"
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
              ...
              <ModalContent>
                ...
                <ModalCloseButton />
                <ModalBody>
                  <Text>• Bond to any Roto Fury satellite DEX to earn a share of the swap fees of that DEX</Text>
                  <Text>• ampFURY or bFURY is required to bond</Text>
