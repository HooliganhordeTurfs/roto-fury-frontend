...
const Wallet = () => {
  ...
  useEffect(() => {
    ...
    const defaultChainName =
      currentChainState.network === NetworkType.mainnet ? 'furya' : 'narwhal'
    const defaultWalletChainName = currentChainState.network === NetworkType.mainnet ? 'furya' : 'furyatestnet'
